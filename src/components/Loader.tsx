...
export default function Loader({ onComplete }: { onComplete: () => void }) {
  ...
  const statusLog = statusLogs[logIndex];
  ...
  return (
    <div className="fixed inset-0 bg-black z-50 flex flex-col items-center justify-center select-none overflow-hidden p-8">
      ...
      <div className="absolute w-[450px] h-[450px] bg-amber-900/5 rounded-full blur-[130px] animate-pulse" />
      <div className="absolute w-[350px] h-[350px] bg-yellow-900/5 rounded-full blur-[130px] animate-pulse delay-500" />
